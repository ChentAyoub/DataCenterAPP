...
### Report Highlights:
* **Database Modeling (MLD):** Detailed breakdown of entity relationships for the resources.
* **System Architecture:** Deep dive into the Laravel MVC file structure and custom middleware.
* **Technical Choices:** Justification for using Laravel 12.x, PHP 8.2+, and MySQL.
* **Future Perspectives:** Roadmap for PDF reporting and API RESTful integration.
---
## 🎥 Video Demonstration
